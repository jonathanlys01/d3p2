...
from samplers.utils import (
    load_model, restore_model, generate_particle_seeds,
    compute_sentence_entropy, compute_generative_perplexity
)
...
def run_random_sampling(model, config, num_runs, base_seed):
    ...
    for run_id in range(num_runs):
        ...
        ppl = compute_generative_perplexity(
            model, text, config.eval.gen_ppl_eval_model_name_or_path
        )
