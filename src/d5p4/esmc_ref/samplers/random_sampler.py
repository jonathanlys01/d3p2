...
def random_sampling(model, num_steps: int, seed: int, eps: float = 1e-5) -> Tuple[torch.Tensor, dict]:
    """
    ...
    for step in range(num_steps):
        ...
        if model.sampler == "ddpm":
            ...
            p_x0_cache, sample_next = model._ddpm_caching_update(sample, t, dt, p_x0=p_x0_cache)
    ...
    logs = {"entropy_trajectory": entropy_trajectory, "u_denoise": u_denoise, "seed": seed}
